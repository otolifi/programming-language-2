class Carro:
    ...
    def verificar_pneu(self):
        print("Pressao no pneu 1: ", self.pneu1.pressao)
        print("Pressao no pneu 2: ", self.pneu2.pressao)
        print("Pressao no pneu 3: ", self.pneu3.pressao)
        print("Pressao no pneu 4: ", self.pneu4.pressao)
